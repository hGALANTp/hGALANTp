...
---
## 🧠 Sobre mim
Sou um profissional em **transição de carreira**, formado em **Ciência de Dados pela EBAC** e **Desenvolvimento Full Stack Python pela Ultima School**, **inglês fluente** e cursando (trancado) o último período em **Administração pela Estácio de Sá**.
Tenho experiência sólida na área **Administrativa**, especialmente em **negócios e finanças**, o que fortalece minha capacidade analítica e visão estratégica.
